...
public class AnimatedDrawable implements Drawable {
     ...
     * @param textureHandle
     */
    public AnimatedDrawable(final long tickStart, final double xStart, final double yStart, final long tickEnd, final double xEnd, final double yEnd, final int z, final String textureHandle) {
