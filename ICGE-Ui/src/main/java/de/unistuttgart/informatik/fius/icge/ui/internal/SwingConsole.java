...
/**
 * The SwingConsole allows the user to see text output from the system or the
 * simulation itself.
 *
...
public class SwingConsole extends JTabbedPane implements Console {
    ...
    public SwingConsole() {
        ...
        {   // Setup simulation console
            ...
            DefaultCaret caret = (DefaultCaret) this.simulationConsole.getCaret();
        ...
        {   // Setup system console
            ...
            DefaultCaret caret = (DefaultCaret) this.systemConsole.getCaret();
            caret.setUpdatePolicy(DefaultCaret.ALWAYS_UPDATE);
