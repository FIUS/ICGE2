...
public class AnimatedTexture implements Texture{
     ...
     * @param loop set to true if the animation should loop
     */
     ...
     * 
     * @param frameTexture the texture handle of the texture to add.
     * @param frames the number of frames the texture should show
     */
     ...
     * 
     * @param frame the current frame
     * @param animationStart offset for the start frame of the animation
     * @return the texture for the frame
     */
