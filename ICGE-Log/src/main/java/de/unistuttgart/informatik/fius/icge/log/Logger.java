...
public abstract class Logger {
     ...
     *
     * @param stream The {@link OutputStream} to add
     * @return Returns true if successfull
     * @see OutputStreamMultiplier#addOutputStream(OutputStream)
     */
    public static boolean addSimulationOutputStream(OutputStream stream) {
     ...
     *
     * @param stream The {@link OutputStream} to remove
     * @return Returns true if successfull
     * @see OutputStreamMultiplier#removeOutputStream(OutputStream)
     */
    public static boolean removeSimulationOutputStream(OutputStream stream) {
